...
echo $(pwd)
sleep 2
sudo -uroot ./configure --prefix=/usr --libexecdir=/usr/lib --with-secure-path --with-all-insults --with-env-editor --docdir=/usr/share/doc/$lastdir1 --with-passprompt="[sudo] password for %p: "
sudo -uroot make
